...
def build_rows():
    ...
    rows = [
        ...
        ["★ 공극률 Vp (실제 재료)", "복합재 총 공극률",
         vp, "-", "refs/[10] Yang의 rho=2.0 g/cm3, Vf=40 %에서 역산. "
         "같은 산식이 refs/[36]의 발표값 17.0 %를 0.03 % 오차로 재현", "검증",
         "refs/[43]의 13 %는 자기 밀도와 불일치(열린 공극으로 추정) — 사용하지 않음"],
