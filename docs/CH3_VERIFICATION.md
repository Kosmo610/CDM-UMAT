...
| `atmosphere_verdicts.py --check` | **a1의 분류 판정** — a2 census 위에 얹는 귀속 심사. a2 인용 3건의 PDF 재독·[5] 대 [10] 36.2 %p 간극의 **상온 대조(1.76배)와 [10] 자신의 무산화 예측(21.8 %)** 재유도·「대기 대가 2/3」 귀속 철회가 본문에 반영됐는가·[12] 등급 불변과 **온도 미기재** 가정의 명문화·[67] 3D 편조 → 표적 아닌 민감도 | 42 |
