...
| `plastic_dissipation_audit.py` | Ge 식 (23)(24) 소성 자유에너지가 $A_m$ 에 들어가는가 — **「누락」 지적 철회**와 그 자리에 들어갈 메시 의존 한계 | 10 |
...
| `compare_cyclejump.py --selftest` | cycle-jump 오차 판정 규칙 + refs/[57]·[58] 역할 분리와 10배 격차 + **d_cyc 바닥 아래면 VOID**(0812 400 % 오보 재현) | 17 |
