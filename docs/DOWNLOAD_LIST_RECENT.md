...
## 23. **[B]** SiC/SiC **편조관 열충격 사이클 + 잔여강도** — 석영램프 가열, C-ring
...
## 24. **[B]** Li Longbiao — **온도의존 비례한도(PLS)** of C/SiC, 에너지 평형 접근
- *Ceramics-Silikáty* **63**(3) (2019). DOI ✔ `10.13168/cs.2019.0028`. **OA**.
