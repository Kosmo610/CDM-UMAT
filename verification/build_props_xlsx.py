...
ROWS = [
    ...
    ('F', 'PROPS 32 GF1T', '얀 축방향 파괴에너지 (크랙밴드, V2_6)', 0.03962, 'N/mm', 'fine 메쉬에서 A1T=2.0 재현하도록 역산 (논문 미기재)', '수치설정', '[정정필요] 0.0570 은 coarse 26k 메쉬 값이었다. fine 메쉬 얀 CELENT 체적가중평균은 0.03269 (mesh_celent_stats.py) 이므로 A1TEFF 가 2.0 이 아니라 0.77 이 되어 23C 강도가 125.81->139.43 (+10.8%). 정정값 GF1T=0.022728 N/mm'),
