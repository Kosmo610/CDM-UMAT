...
TAGMAP = {
    ...
    '_500C': (500, '500C via 23C'),
    '_peek500': (500, '500C peek'),
    '_1000C': (1000, '1000C via 23C'),
    # DIRECT 배치: 1050 -> 시험온도 직행 (23 C 를 경유하지 않음)
    '_500D': (500, '500C direct'),
    '_1000D': (1000, '1000C direct'),
    # DIRECT 를 V2_5 카드(GF1T 없음)로 돌린 것. XT=421 보정과 같은 카드.
    '_500D5': (500, '500C direct V2_5'),
    # P2 카드 온도 시리즈 (23 C 는 _P2). 세 점이 같은 카드·같은 span.
    '_P2T500': (500, '500C P2 card'),
    '_P2T1000': (1000, '1000C P2 card'),
    '_1000D5': (1000, '1000C direct V2_5'),
    ...
    '_P1': (23, '23C P1 +MCRIT'),
    '_P2': (23, '23C P2 +Yt50'),
    # P3 = P2 와 모든 것이 같고 얀 XT 만 421 -> 2835 (논문 자신의 값).
    # 미리 등록해 둔다. 안 그러면 파일명 추정이 '_P3T1000' 에서 3 을
    # 집을 수 있고, '_P3' 는 23 C 로 맞더라도 이름표가 뭉개진다.
    '_P3': (23, '23C P3 XT2835'),
    '_P3T500': (500, '500C P3 XT2835'),
    '_P3T1000': (1000, '1000C P3 XT2835'),
    # P4 = P3 + 얀 A1T (슬롯 18) 2.0 -> 50.0. 크랙밴드가 논문 XT 에서
    # 주는 클램프값이며, 재경화(종국 파괴 부재)가 연화지수 때문인지
    # 검정한다. §5.25 사전등록.
    '_P4': (23, '23C P4 A50'),
    '_P4T500': (500, '500C P4 A50'),
    '_P4T1000': (1000, '1000C P4 A50'),
}
